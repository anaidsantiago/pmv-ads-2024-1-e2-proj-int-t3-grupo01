...
namespace GestLab.Migrations
{
    ...
    [Migration("20240504181905_AddLenteEsquerdaPedido")]
    partial class AddLenteEsquerdaPedido
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GestLab.Models.PedidoModel", b =>
                {
                    ...
                    b.Property<int?>("LenteEsquerdaIdId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestLab.Models.PedidoModel", b =>
                {
                    ...
                    b.HasOne("GestLab.Models.ProdutoModel", "LenteEsquerdaId")
                        .WithMany()
                        .HasForeignKey("LenteEsquerdaIdId");
